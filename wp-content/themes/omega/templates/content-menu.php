<section class="home-banner container">
  <div class="row">
    <div class="col-md-12 col-lg-12 noPadding" id="main-banner-container" >
      <div id="main-banner">
        <?
                $args = array( 'numberposts' => -1, 'post_type' => 'menu_banner', 'post_status' => 'publish', 'order' => 'ASC', 'orderby' => 'menu_order', 'suppress_filters' => 0);
	...
	<div class="row">
    	<div class="col-sm-10 col-sm-push-1">
			...
			<div class="col-sm-4">
                ...
                <p>Click <a href="<?=get_field("menu_pdf",$post->ID); ?>" target="_blank">here</a> to download our latest menu</p>
            </div>
            <div class="col-sm-8">
